package practise.myproman.api.service.component;
...
/**
 * PasswordCryptographyProvider implements OWASP recommendation password
 * security - Salt and SHA512.
 */
@Component
public class PasswordCryptographyProvider {
    ...
    /**
     * This method re-generates hashed Password from raw-password and salt. This
