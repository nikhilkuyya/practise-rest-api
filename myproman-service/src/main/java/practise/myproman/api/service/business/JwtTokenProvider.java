...
import practise.myproman.api.service.common.GenericErrorCode;
import practise.myproman.api.service.common.UnexpectedException;
...
public class JwtTokenProvider {
    ...
    private static final String TOKEN_ISSUER = "https://myproman.io";
    ...
    public String generateToken(final String userUuid, final ZonedDateTime issuedDateTime,
        ...
        return JWT.create().withIssuer(TOKEN_ISSUER) //
                .withKeyId(UUID.randomUUID().toString()).withAudience(userUuid) //
